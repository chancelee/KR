# Microsoft Developer Studio Generated NMAKE File, Based on name.dsp
!IF "$(CFG)" == ""
CFG=name - Win32 Debug
!MESSAGE No configuration specified. Defaulting to name - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "name - Win32 Release" && "$(CFG)" != "name - Win32 Debug"
...
!INCLUDE "name.dep"
!ELSE 
!MESSAGE Warning: cannot find "name.dep"
!ENDIF 
!ENDIF 
