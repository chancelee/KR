...
ALL : "$(OUTDIR)\string_cut.exe" "$(OUTDIR)\string_cut.bsc"


CLEAN :
	-@erase "$(INTDIR)\string_cut.obj"
	-@erase "$(INTDIR)\string_cut.sbr"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(OUTDIR)\string_cut.bsc"
	-@erase "$(OUTDIR)\string_cut.exe"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\string_cut.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ  /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\string_cut.bsc" 
BSC32_SBRS= \
	"$(INTDIR)\string_cut.sbr"

"$(OUTDIR)\string_cut.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
...
"$(INTDIR)\string_cut.obj"	"$(INTDIR)\string_cut.sbr" : $(SOURCE) "$(INTDIR)"
