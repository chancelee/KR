...
ALL : "$(OUTDIR)\verify.exe" "$(OUTDIR)\verify.bsc"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\verify.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ  /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\verify.bsc" 
BSC32_SBRS= \
	"$(INTDIR)\hash.sbr" \
